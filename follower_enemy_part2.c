...
void	follower_part4(t_gamedata *game, t_follower monstr, \
...
void	follower_part5(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
	if (ft_if_else(game, x_axis + 1, y_axis))
...
void	follower_part6(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
...
void	follower_part7(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
	if (ft_if_else(game, x_axis - 1, y_axis))
	{
...
void	follower_part8(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
	if (ft_if_else(game, x_axis + 1, y_axis))
	{
