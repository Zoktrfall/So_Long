...
void	follower_part1(t_gamedata *game, t_follower monstr, \
...
void	follower_part2(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
...
void	follower_part3(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
	if (ft_if_else(game, x_axis, y_axis + 1))
