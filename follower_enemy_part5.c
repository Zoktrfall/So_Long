...
void	follower_part9(t_gamedata *game, t_follower monstr, \
...
void	follower_part10(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
...
void	follower_part11(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
...
void	follower_part12(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
	if (ft_if_else(game, x_axis + 1, y_axis))
	{
...
void	follower_part13(t_gamedata *game, t_follower monstr, \
				int x_axis, int y_axis)
{
	if ((game->map)[y_axis - 1][x_axis] == 'C')
		(game->flags_medus)[monstr.color_medus][1] = 1;
